...
description: Generate visual, self-contained HTML slide decks with rich components and presentation navigation. Use when the user asks to make a slide deck, create slides, build a presentation, or generate slides.
---
